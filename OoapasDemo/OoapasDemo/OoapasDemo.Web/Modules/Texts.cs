...
namespace OoapasDemo {
    ...
    public static partial class Texts {
        ...
        public static class Forms {
            public static class Membership {
                ...
                public static class ResetPassword {
                    public static LocalText EmailSubject = "Reset Your OoapasDemo Password";
                ...
                public static class SignUp {
                    public static LocalText ActivateEmailSubject = "Activate Your OoapasDemo Account";
                    ...
                    public static LocalText FormTitle = "Sign up for OoapasDemo";
        ...
        public static class Navigation {
            ...
            public static LocalText SiteTitle = "OoapasDemo";
        }
